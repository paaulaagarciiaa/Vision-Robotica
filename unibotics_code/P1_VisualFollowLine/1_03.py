# Paula Garcia 1 marzo cambiamos al coche ackermann
# Aunque los controladores no funcionasen perfectamente con el otro coche, como ya era capaz de dar una vuelta entera en uno 50 segundos
# intento modificar el código para que funcione en el mismo circuito pero con el coche Ackermann
...
# Dificultades con las que me estoy encontrando es que el coche Ackermann en línea recta oscila más, por la tracción trasera de este,
